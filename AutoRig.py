...
femal_bone_data = {
"origin": Vector((0.0,0.030188,0.90654)), # 添加这个键来定义骨架的原点位置
...
"Bip001 Spine2": {"parent": "Bip001 Spine1", "head": Vector((0.0000, 0.0001, 0.2853)), "tail": Vector((0.0000, -0.1694, 0.2851))},
...
"Bip001 L Clavicle": {"parent": "Bip001 Spine2", "head": Vector((0.0797, -0.0082, 0.4254)), "tail": Vector((0.0797, 0.0461, 0.4254))},
"Bip001 L UpperArm": {"parent": "Bip001 L Clavicle", "head": Vector((0.1341, -0.0082, 0.4254)), "tail": Vector((0.1248, 0.2859, 0.4547))},
"Bip001 L Forearm": {"parent": "Bip001 L UpperArm", "head": Vector((0.4297, 0.0006, 0.4303)), "tail": Vector((0.4376, 0.2191, 0.4522))},
"Bip001 L Hand": {"parent": "Bip001 L Forearm", "head": Vector((0.6492, -0.0076, 0.4324)), "tail": Vector((0.6503, 0.0004, 0.3525))},
"Bip001 L Finger0": {"parent": "Bip001 L Hand", "head": Vector((0.6986, -0.0604, 0.4110)), "tail": Vector((0.6985, -0.0604, 0.3820))},
"Bip001 L Finger01": {"parent": "Bip001 L Finger0", "head": Vector((0.7276, -0.0615, 0.4109)), "tail": Vector((0.7275, -0.0615, 0.3837))},
"Bip001 L Finger0Nub": {"parent": "Bip001 L Finger01", "head": Vector((0.7549, -0.0625, 0.4108)), "tail": Vector((0.7547, -0.0625, 0.3835))},
"Bip001 L Finger1": {"parent": "Bip001 L Hand", "head": Vector((0.7272, -0.0419, 0.4360)), "tail": Vector((0.7276, -0.0419, 0.3900))},
"Bip001 L Finger11": {"parent": "Bip001 L Finger1", "head": Vector((0.7732, -0.0421, 0.4365)), "tail": Vector((0.7734, -0.0421, 0.4077))},
"Bip001 L Finger1Nub": {"parent": "Bip001 L Finger11", "head": Vector((0.8020, -0.0423, 0.4367)), "tail": Vector((0.8022, -0.0423, 0.4079))},
"Bip001 L Finger2": {"parent": "Bip001 L Hand", "head": Vector((0.7283, 0.0064, 0.4370)), "tail": Vector((0.7287, 0.0064, 0.3923))},
"Bip001 L Finger21": {"parent": "Bip001 L Finger2", "head": Vector((0.7729, 0.0054, 0.4374)), "tail": Vector((0.7732, 0.0054, 0.4076))},
"Bip001 L Finger2Nub": {"parent": "Bip001 L Finger21", "head": Vector((0.8027, 0.0047, 0.4377)), "tail": Vector((0.8030, 0.0047, 0.4079))},
"Bip001 R Clavicle": {"parent": "Bip001 Spine2", "head": Vector((-0.0797, -0.0082, 0.4254)), "tail": Vector((-0.0797, 0.0461, 0.4254))},
"Bip001 R UpperArm": {"parent": "Bip001 R Clavicle", "head": Vector((-0.1341, -0.0082, 0.4254)), "tail": Vector((-0.1248, 0.2859, 0.4547))},
"Bip001 R Forearm": {"parent": "Bip001 R UpperArm", "head": Vector((-0.4297, 0.0006, 0.4303)), "tail": Vector((-0.4376, 0.2191, 0.4522))},
"Bip001 R Hand": {"parent": "Bip001 R Forearm", "head": Vector((-0.6492, -0.0076, 0.4324)), "tail": Vector((-0.6503, 0.0004, 0.3525))},
"Bip001 R Finger0": {"parent": "Bip001 R Hand", "head": Vector((-0.6986, -0.0604, 0.4110)), "tail": Vector((-0.6985, -0.0604, 0.3820))},
"Bip001 R Finger01": {"parent": "Bip001 R Finger0", "head": Vector((-0.7276, -0.0615, 0.4109)), "tail": Vector((-0.7275, -0.0615, 0.3837))},
"Bip001 R Finger0Nub": {"parent": "Bip001 R Finger01", "head": Vector((-0.7549, -0.0625, 0.4108)), "tail": Vector((-0.7547, -0.0625, 0.3835))},
"Bip001 R Finger1": {"parent": "Bip001 R Hand", "head": Vector((-0.7272, -0.0419, 0.4360)), "tail": Vector((-0.7276, -0.0419, 0.3900))},
"Bip001 R Finger11": {"parent": "Bip001 R Finger1", "head": Vector((-0.7732, -0.0421, 0.4365)), "tail": Vector((-0.7734, -0.0421, 0.4077))},
"Bip001 R Finger1Nub": {"parent": "Bip001 R Finger11", "head": Vector((-0.8020, -0.0423, 0.4367)), "tail": Vector((-0.8022, -0.0423, 0.4079))},
"Bip001 R Finger2": {"parent": "Bip001 R Hand", "head": Vector((-0.7283, 0.0064, 0.4370)), "tail": Vector((-0.7287, 0.0064, 0.3923))},
"Bip001 R Finger21": {"parent": "Bip001 R Finger2", "head": Vector((-0.7729, 0.0054, 0.4374)), "tail": Vector((-0.7732, 0.0054, 0.4076))},
"Bip001 R Finger2Nub": {"parent": "Bip001 R Finger21", "head": Vector((-0.8027, 0.0048, 0.4377)), "tail": Vector((-0.8030, 0.0048, 0.4079))},
...
empty_coords_male_name_example = [
    ...
    ("R UpperArm_example", Vector((-0.3555, -0.0055, 1.4089))),
    ("R Thigh_example", Vector((-0.0934, -0.0221, 0.7384))),
    ("R Hand_example", Vector((-0.7695, 0.0003, 1.4246))),
    ("R Forearm_example", Vector((-0.5733, -0.0020, 1.4179))),
    ("R Finger2_example", Vector((-0.8162, 0.0122, 1.4216))),
    ("R Finger21_example", Vector((-0.8493, 0.0126, 1.4224))),
    ("R Finger1_example", Vector((-0.8163, -0.0408, 1.4228))),
    ("R Finger11_example", Vector((-0.8498, -0.0408, 1.4228))),
    ("R Finger0_example", Vector((-0.7737, -0.0623, 1.3918))),
    ("R Finger01_example", Vector((-0.8048, -0.0623, 1.3918))),
    ("Pelvis_example", Vector((-0.0006, -0.0221, 0.9410))),
    ("L UpperArm_example", Vector((0.3565, -0.0091, 1.4086))),
    ("L Thigh_example", Vector((0.0921, -0.0221, 0.7384))),
    ("L Hand_example", Vector((0.7705, -0.0032, 1.4243))),
    ("L Forearm_example", Vector((0.5743, -0.0055, 1.4176))),
    ("L Finger2_example", Vector((0.8116, 0.0090, 1.4221))),
    ("L Finger21_example", Vector((0.8463, 0.0090, 1.4221))),
    ("L Finger1_example", Vector((0.8130, -0.0408, 1.4228))),
    ("L Finger11_example", Vector((0.8466, -0.0408, 1.4228))),
    ("L Finger0_example", Vector((0.7746, -0.0623, 1.3918))),
    ("L Finger01_example", Vector((0.8042, -0.0623, 1.3918))),
